...
public class TambahSiswa extends javax.swing.JFrame {
    ...
    public TambahSiswa() {
        ...
        String[] judul = {"Nama", "Kelas", "Nomor Induk"};
        def_mod = new DefaultTableModel(null, judul);
        tabelSiswa.setModel(def_mod);
        tampilData();
    }
    ...
    final void tampilData()
    {
        try
        {
            ...
            while(rs.next())
            {
                ...
                String[] kolom = {nama, kelas, nomor_induk};
    ...
    private void tambahGuruActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahGuruActionPerformed
        // TODO add your handling code here:
        this.setVisible(false);
        TambahGuru tambahguru = new TambahGuru();
        tambahguru.setVisible(true);
